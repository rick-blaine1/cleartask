...
- **Deliverable:** Trust boundary policy document in [`docs/`](docs/)
...
- **Deliverable:** Input processing module in [`backend/`](backend/)
...
- **Deliverable:** Input validation logic in [`backend/app.js`](backend/app.js)

---

### Phase 2: Prompt Engineering & LLM Interaction (350 tokens)

**Goal:** Formalize the instruction hierarchy and implement semantic containment in all LLM prompts.

#### Subtask 2.1: Formalize Instruction Hierarchy (100 tokens)
...
- **Deliverable:** Updated prompts in [`backend/app.js`](backend/app.js)

#### Subtask 2.2: Implement Semantic Containment and Delimiters (150 tokens)
...
- **Deliverable:** Enhanced prompt structure in [`backend/app.js`](backend/app.js)

#### Subtask 2.3: Prompt Templating for Structured Input (100 tokens)
...
- **Deliverable:** Prompt template utilities in [`backend/`](backend/)

---

### Phase 3: Output Validation & Application Logic (500 tokens)
...
#### Subtask 3.1: Define Strict Output Schemas (150 tokens)
...
- **Deliverable:** Schema definitions in [`backend/`](backend/) or separate schema files

#### Subtask 3.2: Implement Output Validation Logic (150 tokens)
...
- **Deliverable:** Validation logic in [`backend/app.js`](backend/app.js)

#### Subtask 3.3: Implement Fail-Closed Safe Modes (100 tokens)
...
- **Deliverable:** Fail-closed logic in [`backend/app.js`](backend/app.js)

#### Subtask 3.4: Enforce Separation of Responsibilities in Code (100 tokens)
...
- **Deliverable:** Refactored application logic in [`backend/app.js`](backend/app.js)
...
#### Subtask 4.1: Enhanced Logging for LLM Interactions (100 tokens)
...
- **Deliverable:** Enhanced logging in [`backend/app.js`](backend/app.js)
