...
* **Informational Catch-All:** If no clear action is found, a task titled `"Review email from [Sender]: [Subject]"` is created if the email references a future decision or dependency.
